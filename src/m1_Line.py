...
class Line(object):
    ...
    def clone(self):
        ...
        Type hints:
          :rtype: Line
          Returns a new Line whose START is a clone of
          this Line's START and whose END is a clone of this Line's END.
        """
        # --------------------------------------------------------------
        # DONE: 4.
    ...
    def length(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        length = Point.distance_from(self.start, self.end)
        return length
    ...
    def midpoint(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        return Point.halfway_to(self.start, self.end)
